...
class UserResource extends JsonResource
{
    ...
    private function getProfileType(): ?string
    {
        ...
        return match ($this->profileable_type) {
            \App\Models\CustomerProfile::class => 'customer',
            \App\Models\BusinessUserProfile::class => 'business',
            \App\Models\StaffUserProfile::class => 'staff',
            default => null
        };
    }
    ...
    private function getProfileData(): ?array
    {
        ...
        if ($this->profileable instanceof \App\Models\CustomerProfile) {
            return [
        ...
        if ($this->profileable instanceof \App\Models\BusinessUserProfile) {
            return [
                'id' => $this->profileable->id,
        ...
        if ($this->profileable instanceof \App\Models\StaffUserProfile) {
            return [
                'id' => $this->profileable->id,
